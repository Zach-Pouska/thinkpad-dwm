...
static const Rule rules[] = {
	...
	{ "Authentication Required", NULL, NULL,  0,        1,           -1 },
};
...
//      I want this one to be like ctrl + win + left/right for switching between tags, so then I can configure that to be the touchpad gesture 
	TAGKEYS(                        XK_1,                      0)
	TAGKEYS(                        XK_2,                      1)
	TAGKEYS(                        XK_3,                      2)
	TAGKEYS(                        XK_4,                      3)
